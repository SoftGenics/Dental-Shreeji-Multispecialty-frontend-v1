...
const Header = () => {
  ...
  <Navbar  variant="light" fixed='top' className='top-nav mb-3'>
   ...
   <Marquee className='marque-text' gradient={false}><Navbar.Brand  as={Link} to="/Notification"><img src='images/event.gif' alt='notify'></img><span className='offer-text'>Check Offers click here</span></Navbar.Brand></Marquee>
    </Nav>
    <Navbar.Toggle aria-controls="responsive-navbar-nav" />
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="navbar-nav ms-auto mb-2 mb-lg-0">
      <Nav.Link href="tel:+917800230430"><i className="fas fa-phone-alt" />+91 7800230430</Nav.Link>
